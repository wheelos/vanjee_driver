...
namespace lidar
{
    ...
    struct WJInputParam 
    {
      uint32_t connect_type = 1;
      uint32_t host_msop_port = 3333;             
      uint32_t lidar_msop_port = 3001;
      ...
      bool use_vlan = false;                 
      uint32_t user_layer_bytes = 0;         
      uint32_t tail_layer_bytes = 0;         
      void print() const
      {
        WJ_INFO << "-----------------------------------------------------------" << WJ_REND;
